"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{5002:function(e,t,n){n.d(t,{IO:function(){return i2},JU:function(){return ik},PL:function(){return ss},QT:function(){return sr},ad:function(){return iR},hJ:function(){return iN},oe:function(){return so},pl:function(){return sa}});var r,i,s,a,o=n(8885),l=n(2680),u=n(9053),h=n(3943),c=n(6552),d=n(4575);n(357);var f=n(6300).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sr(e){e=iE(e,iS);let t=iE(e.firestore,ib);return(function(e,t,n={}){let r=new A;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new io({next:s=>{t.enqueueAndForget(()=>rM(e,a));let o=s.docs.has(n);!o&&s.fromCache?i.reject(new S(C.UNAVAILABLE,"Failed to get document because the client is offline.")):o&&s.fromCache&&r&&"server"===r.source?i.reject(new S(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(s)},error:e=>i.reject(e)}),a=new rU(new e3(n.path),s,{includeMetadataChanges:!0,ra:!0});return rV(e,a)})(await im(e),e.asyncQueue,t,n,r)),r.promise})(ix(t),e._key).then(n=>(function(e,t,n){let r=n.docs.get(t._key),i=new si(e);return new se(e,i,t._key,r,new i7(n.hasPendingWrites,n.fromCache),t.converter)})(t,e,n))}class si extends i6{constructor(e){super(),this.firestore=e}convertBytes(e){return new iV(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iS(this.firestore,null,t)}}function ss(e){e=iE(e,iC);let t=iE(e.firestore,ib),n=ix(t),r=new si(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new S(C.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),(function(e,t,n={}){let r=new A;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new rU(n,new io({next:n=>{t.enqueueAndForget(()=>rM(e,s)),n.fromCache&&"server"===r.source?i.reject(new S(C.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),{includeMetadataChanges:!0,ra:!0});return rV(e,s)})(await im(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new sn(t,r,e,n)))}function sa(e,t,n){var r;e=iE(e,iS);let i=iE(e.firestore,ib),s=(r=e.converter)?n&&(n.merge||n.mergeFields)?r.toFirestore(t,n):r.toFirestore(t):t;return sl(i,[(function(e,t,n,r,i,s={}){let a,o;let l=e.Fu(s.merge||s.mergeFields?2:0,t,n,i);ij("Data must be an object, but it was:",l,r);let u=iQ(r,l);if(s.merge)a=new eo(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let r of s.mergeFields){let i=function(e,t,n){if((t=(0,h.m9)(t))instanceof iM)return t._internalPath;if("string"==typeof t)return iH(e,t);throw iY("Field path arguments must be of type string or ",e,!1,void 0,n)}(t,r,n);if(!l.contains(i))throw new S(C.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);(function(e,t){return e.some(e=>e.isEqual(t))})(e,i)||e.push(i)}a=new eo(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new iU(new eV(u),a,o)})(iz(i),"setDoc",e._key,s,null!==e.converter,n).toMutation(e._key,tD.none())])}function so(e){return sl(iE(e.firestore,ib),[new tq(e._key,tD.none())])}function sl(e,t){return function(e,t){let n=new A;return e.asyncQueue.enqueueAndForget(async()=>rJ(await id(e).then(e=>e.syncEngine),t,n)),n.promise}(ix(e),t)}new WeakMap,function(e=!0){p=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,{instanceIdentifier:n,options:r})=>{let i=t.getProvider("app").getImmediate(),s=new ib(new b(t.getProvider("auth-internal")),new V(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new S(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ew(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:e},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(m,"4.6.4",void 0),(0,o.KN)(m,"4.6.4","esm2017")}()}}]);